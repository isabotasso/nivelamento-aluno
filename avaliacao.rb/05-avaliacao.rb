...
# Escreva uma função chamada "calcula_pi" que recebe o número de termos a serem usados na fórmula de 
# Leibniz para obter o valor de PI. O resultado do cálculo deve ser retornado pela função.

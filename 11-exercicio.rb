...
puts posicao_no_array(array, 55)
puts posicao_no_array(array, 60)
puts posicao_no_array(array, 10)
puts posicao_no_array(array, 44)
puts posicao_no_array(array, 30)